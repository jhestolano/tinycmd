...
static StCode_e simple_cmd_callback(Arg_s* args, void* usrargs) {
  (void)args;
  (void)usrargs;
...
static StCode_e cmd_no_args_callback(Arg_s* args, void* usrargs) {
  (void)args;
  (void)usrargs;
...
static StCode_e cmd_max_arg_callback(Arg_s* args, void* usrargs) {
  (void)usrargs;
...
static StCode_e cmd_one_arg_callback(Arg_s* args, void* usrargs) {
  (void)usrargs;
